...
class PhysicsInformedNN(object):
    def __init__(self, layers, h_activation_function, logger, simul_constants, domain, physics_scale, lr, data,
        ...
        self.model = tf.keras.Model(inputs=inputs, outputs=outputs, name="sa_pinn_model")
        ...
        self.optimizer_sa = tf.keras.optimizers.legacy.Adam(learning_rate=0.005, beta_1=.90)
